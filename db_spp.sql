...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2023 at 07:33 AM
...
(2, 1931, '0001', '2023-03-17', 'Januari', '2023', '2023-1', 10000),
(3, 1931, '0002', '2023-03-17', 'Maret', '2023', '2023-2', 12000),
(4, 1931, '0003', '2023-03-17', 'Maret', '2023', '2023-1', 10000),
(5, 1931, '0001', '2023-03-17', 'Januari', '2023', '2023-1', 10000);
...
(1931, 'admin', '123', 'ali', 'admin'),
(1932, 'adam', '123', 'adam cul', 'petugas');
...
('0001', '001', 'adam', 'X-RPL', 'lampung', '128931', '2023-1'),
('0002', '002', 'jodi', 'X-TKR', 'lampung', '091202', '2023-2'),
('0003', '003', 'adam', 'XI-RPL', 'Lampung Barat', '123123', '2023-1');
...
--
ALTER TABLE `petugas`
  MODIFY `id_petugas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1933;
